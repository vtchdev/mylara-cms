@include('admin.head')
  ...
  <div class="row">
    <div class="col-xl">
      <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h5 class="mb-0">სტატიკური გვერდის დამატება</h5>
    ...
    @endif
        ...
        <div class="card-body">
          <form action="{{ url('add_page_confirm') }}" method="POST" enctype="multipart/form-data">
@csrf
            <div class="mb-3">
              <label class="form-label" for="basic-default-fullname">გვერდის დასახელება</label>
              <input type="text" name="title" class="form-control" id="basic-default-fullname" placeholder="სტატიის დასახელება" />
            </div>
            
            <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">SLUG URL</label>
                <input type="text" name="slug" class="form-control" id="basic-default-fullname" placeholder="სლაგი მხოლოდ ლათინურად" />
              </div>


            <div class="mb-3">
                <label class="form-label" for="basic-default-message">გვერდის აღწერა</label>
